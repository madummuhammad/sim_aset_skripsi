...
class NotifikasiController extends Controller
{
    public function index()
    {
        ...
        {    
            $notifikasi=Notifikasi::with('mutasi','pemusnahan')->where('jenis_notifikasi', 'Persetujuan Mutasi')->orWhere('jenis_notifikasi', 'Persetujuan Pemusnahan')->orWhere('jenis_notifikasi','Pengecekan Kondisi')->orderBy('id','DESC')->get();
        }
