                    ...
                    <div class="row page-titles mx-0">
                        <div class="col-sm-8 p-md-0">
                            <div class="welcome-text">
                                ...
                                <span>Halaman ini digunakan untuk mengubah data aset ketika terjadi kesalahan input pada awal penginputan</span>
                            </div>
                        </div>
                        <div class="col-sm-4 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active"><a href="{{url('asset')}}">Aset</a></li>
