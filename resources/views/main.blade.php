                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    ...
                                    @if (DB::table('notifikasi')->where('read_at', null)->where('jenis_notifikasi', 'Pengajuan Mutasi')->orWhere('jenis_notifikasi', 'Pengajuan Pemusnahan')->count() >
                                        0 and
                                        auth()->user()->id_hak_akses == 3)
                                        <div class="pulse-css"></div>
                                    @elseif(auth()->user()->id_hak_akses == 1 and
                                        DB::table('notifikasi')->where('read_at', null)->where('jenis_notifikasi', 'Pengecekan Kondisi')->count() >
                                            0 or
                                        DB::table('notifikasi')->where('read_at', null)->where('jenis_notifikasi', 'Persetujuan Mutasi')->count() >
                                            0 or
                                        DB::table('notifikasi')->where('read_at', null)->where('jenis_notifikasi', 'Persetujuan Pemusnahan')->count() >
                                            0)
                                        {{-- <div class="pulse-css"></div> --}}
                                    @elseif(auth()->user()->id_hak_akses == 2 and
                                        DB::table('notifikasi')->where('read_at', null)->where('jenis_notifikasi', 'Pengecekan Kondisi')->count() >
                                            0 or
                                        DB::table('notifikasi')->where('read_at', null)->where('jenis_notifikasi', 'Persetujuan Mutasi')->count() >
                                            0 or
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <ul class="list-unstyled">
                                        @foreach (DB::table('notifikasi')->orderBy('id', 'DESC')->limit(5)->get() as $value)
                                            @if (auth()->user()->id_hak_akses == 3 and $value->jenis_notifikasi == 'Pengajuan Mutasi' or
                                                $value->jenis_notifikasi == 'Pengajuan Pemusnahan' and auth()->user()->id_hak_akses == 3)
                                                <li
                                                    class="media dropdown-item @if ($value->read_at == null) {{ 'bg-light' }} @endif">
                                            ...
                                            @endif
                                            {{-- @if (auth()->user()->id_hak_akses == 3 and $value->jenis_notifikasi == 'Pengajuan Mutasi' or $value->jenis_notifikasi == 'Pengajuan Pemusnahan')
                                            ...
                                            @elseif(auth()->user()->id_hak_akses == 1 and $value->jenis_notifikasi == 'Pengecekan Kondisi' or
                                                $value->jenis_notifikasi == 'Persetujuan Mutasi' or
                                                $value->jenis_notifikasi == 'Persetujuan Pemusnahan')
                                                <li
                                                    class="media dropdown-item @if ($value->read_at == null) {{ 'bg-light' }} @endif">
                                                    <!-- <span class="success"><i class="ti-user"></i></span> -->
                                                    <div class="media-body">
                                            ...
                                            @elseif(auth()->user()->id_hak_akses == 2 and $value->jenis_notifikasi == 'Pengecekan Kondisi' or
                                                $value->jenis_notifikasi == 'Persetujuan Mutasi' or
                                                $value->jenis_notifikasi == 'Persetujuan Pemusnahan')
                                                <li
                                                    class="media dropdown-item @if ($value->read_at == null) {{ 'bg-light' }} @endif">
